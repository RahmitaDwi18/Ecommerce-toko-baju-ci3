...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?= base_url(); ?>assets/images/logo/minimslm.png" type="image/x-icon">
  ...
  ?>
    ...
    <div id="wrapper">
      <!-- Sidebar -->
      <ul
        class="navbar-nav bg-info sidebar sidebar-dark accordion"
        id="accordionSidebar"
      >
        <!-- Sidebar - Brand -->
        <a
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">ADMIN MINIMSLM </div>
        </a>
